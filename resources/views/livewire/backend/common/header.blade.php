<div class="header-main px-3 px-lg-4">
    ...
    <div class="dropdown dropdown-profile ms-3 ms-xl-4">
        <a href="" class="dropdown-link" data-bs-toggle="dropdown" data-bs-auto-close="outside"><div class="avatar online">
          <img src="{{ isset(Auth::user()->profile_photo_url) ? Auth::user()->profile_photo_url : "" }}" alt="..."></div></a>
        <div class="dropdown-menu dropdown-menu-end mt-10-f">
          <div class="dropdown-menu-body">
            <div class="avatar avatar-xl online mb-3"><img src="{{ isset(Auth::user()->profile_photo_url) ? Auth::user()->profile_photo_url : "" }}" alt=""></div>
            ...
            <nav class="nav">
              <a href="{{route('profile.show')}}"><i class="ri-edit-2-line"></i> Edit Profile</a>
            </nav>
            <hr>
            <nav class="nav">
